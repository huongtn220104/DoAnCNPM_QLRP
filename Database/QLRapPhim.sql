...
AS
BEGIN
	SELECT id AS [Mã khách hàng], HoTen AS [Họ tên], NgaySinh AS [Ngày sinh], DiaChi AS [Địa chỉ], SDT AS [SĐT], Email AS [Email], DiemTichLuy AS [Điểm tích lũy]
	FROM dbo.KhachHang
END
GO

CREATE PROC USP_InsertCustomer
@idCus VARCHAR(50), @hoTen NVARCHAR(100), @ngaySinh date, @diaChi NVARCHAR(100), @sdt VARCHAR(100), @email NVARCHAR(100)
AS
BEGIN
	INSERT dbo.KhachHang (id, HoTen, NgaySinh, DiaChi, SDT, Email, DiemTichLuy)
	VALUES (@idCus, @hoTen, @ngaySinh, @diaChi, @sdt, @email, 0)
END
GO
...
AS
BEGIN
	SELECT id AS [Mã nhân viên], HoTen AS [Họ tên], NgaySinh AS [Ngày sinh], DiaChi AS [Địa chỉ], SDT AS [SĐT], CMND AS [CMND], ChucVu As [Chức vụ]
	FROM dbo.NhanVien
END
GO

CREATE PROC USP_InsertStaff
@idStaff VARCHAR(50), @hoTen NVARCHAR(100), @ngaySinh date, @diaChi NVARCHAR(100), @sdt VARCHAR(100), @cmnd INT, @chucVu NVARCHAR(100)
AS
BEGIN
	INSERT dbo.NhanVien (id, HoTen, NgaySinh, DiaChi, SDT, CMND, ChucVu)
...
INSERT [dbo].[NhanVien] ([id], [HoTen], [NgaySinh], [DiaChi], [SDT], [CMND], [ChucVu]) VALUES (N'NV00', N'Lê Quốc Huy', CAST(N'2020-04-22' AS Date), N'Quận Thủ Đức - TP HCM', 0123456789, 123456789,N'Quản trị hệ thống')
INSERT [dbo].[NhanVien] ([id], [HoTen], [NgaySinh], [DiaChi], [SDT], [CMND], [ChucVu]) VALUES (N'NV01', N'Phạm Ngọc Hà', CAST(N'2020-04-30' AS Date), N'Quận Thủ Đức - TP HCM', 0213456789, 14725836,N'Nhân viên bán vé')
INSERT [dbo].[NhanVien] ([id], [HoTen], [NgaySinh], [DiaChi], [SDT], [CMND], [ChucVu]) VALUES (N'NV02', N'Trần Ngọc Hương', CAST(N'2020-04-30' AS Date), N'Quận Thủ Đức - TP HCM', 0312456789, 14795836,N'Nhân viên bán vé')
INSERT [dbo].[NhanVien] ([id], [HoTen], [NgaySinh], [DiaChi], [SDT], [CMND], [ChucVu]) VALUES (N'NV03', N'Nguyễn Thị Thu Hiền', CAST(N'2020-04-30' AS Date), N'Quận Thủ Đức - TP HCM', 0312456989, 14799836,N'Quản trị hệ thống')

INSERT [dbo].[TaiKhoan] ([UserName], [Pass], [LoaiTK], [idNV]) VALUES (N'Admin1', N'59113821474147731767615617822114745333', 1, N'NV00')-- mk hiện thị là admin
INSERT [dbo].[TaiKhoan] ([UserName], [Pass], [LoaiTK], [idNV]) VALUES (N'NhanVien1', N'5512317111114510840231031535810616566202691', 2, N'NV01')-- mk hiện thị là 12345
INSERT [dbo].[TaiKhoan] ([UserName], [Pass], [LoaiTK], [idNV]) VALUES (N'NhanVien2', N'5512317111114510840231031535810616566202691', 2, N'NV02')-- mk hiện thị là 12345
INSERT [dbo].[TaiKhoan] ([UserName], [Pass], [LoaiTK], [idNV]) VALUES (N'Admin2', N'59113821474147731767615617822114745333', 1, N'NV03')-- mk hiện thị là admin

INSERT [dbo].[KhachHang] ([id], [HoTen], [NgaySinh], [DiaChi], [SDT], [Email], [DiemTichLuy]) VALUES (N'KH01', N'Nguyễn Văn A', CAST(N'2000-05-01' AS Date), N'Quận 1 - TP HCM', N'0123456789','VanA@gmail.com', 0)
INSERT [dbo].[KhachHang] ([id], [HoTen], [NgaySinh], [DiaChi], [SDT], [Email], [DiemTichLuy]) VALUES (N'KH02', N'Nguyễn Văn B', CAST(N'2000-05-02' AS Date), N'Quận 2 - TP HCM', N'0123456789','VanB@gmail.com', 0)
INSERT [dbo].[KhachHang] ([id], [HoTen], [NgaySinh], [DiaChi], [SDT], [Email], [DiemTichLuy]) VALUES (N'KH03', N'Nguyễn Văn C', CAST(N'2000-05-03' AS Date), N'Quận 3 - TP HCM', N'0123456789','VanC@gmail.com', 0)
INSERT [dbo].[KhachHang] ([id], [HoTen], [NgaySinh], [DiaChi], [SDT], [Email], [DiemTichLuy]) VALUES (N'KH04', N'Nguyễn Văn D', CAST(N'2000-05-04' AS Date), N'Quận 3 - TP HCM', N'0123456789','VanD@gmail.com', 0)
